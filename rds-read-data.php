...
<?php
  ...
  $conn = mysqli_connect($RDS_URL, $RDS_user, $RDS_pwd) or die(mysqli_error());

  mysqli_select_db($conn, $RDS_DB) or die(mysqli_error());
...
if ( $mode=="edit")
 ...
 if ( $mode=="edited")
 {
 mysqli_query ($conn, "UPDATE address SET lastname = '$lastname', firstname = '$firstname', phone = '$phone', email = '$email' WHERE id = $id");
